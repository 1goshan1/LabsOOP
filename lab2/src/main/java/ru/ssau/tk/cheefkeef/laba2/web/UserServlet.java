...
public class UserServlet extends BaseServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            if (pathInfo == null || pathInfo.equals("/")) {
                ...
                handleGetUserById(pathInfo.substring(1), resp);
            } else if (pathInfo.startsWith("/search/by-login/")) {
                handleSearchByLogin(pathInfo.substring("/search/by-login/".length()), resp);
    ...
    protected void doDelete(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            String pathInfo = req.getPathInfo();
            if (pathInfo != null && pathInfo.matches("/\\d+")) {
                handleDeleteUserById(pathInfo.substring(1), resp);
            } else if (pathInfo != null && pathInfo.startsWith("/search/by-login/")) {
                handleDeleteByLogin(pathInfo.substring("/search/by-login/".length()), resp);
            } else {
                handleError(resp, 400, "Неверный путь", req.getRequestURI());
            }
    ...
    private void handleGetUserById(String idStr, HttpServletResponse resp) throws IOException {
    ...
    private void handleSearchByLogin(String login, HttpServletResponse resp) throws IOException {
    ...
    private void handleDeleteUserById(String idStr, HttpServletResponse resp) throws IOException {
    ...
    private void handleDeleteByLogin(String login, HttpServletResponse resp) throws IOException {
